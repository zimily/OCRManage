<template>
    <div>
        ...
        <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="batchNum" label="批次" width="50" align="center">
            </el-table-column>
            ...
            <el-table-column prop="floorWithInspectPart" label="使用部位" width="150" align="center">
            </el-table-column>
            <el-table-column prop="grade" label="强度等级" width="100" align="center">
            </el-table-column>
            <el-table-column prop="condition" label="养护条件" width="100" align="center">
            </el-table-column>
            <el-table-column prop="num" label="代表数量" width="100" align="center">
            </el-table-column>
...
export default {
    ...
    methods: {
        toLedgerEntry() {
            // 使用命名路由跳转
            this.$router.push({ name: 'LedgerEntry' , params: { category: 'beton' }});
        },
         toOCREntry() {
            // 使用命名路由跳转
            this.$router.push({ name: 'OCREntry' , params: { category: 'beton' }});
        },
        // 搜索方法
        search() {
            // 重置到第一页
        ...
        editItem(row) {
            ...
            // 这里可以打开编辑对话框或跳转到编辑页面
            // 示例: this.$router.push({ name: 'editConcrete', params: { id: row.id }})
        },
