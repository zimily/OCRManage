...
export function getAccessToken() { 
    return request({
        url: '/ejc-idm-web/auth/getAccessToken?appId=1836595908945981442&secret=MTgzNjU5NTkwODk0NTk4MTQ0Mg==',
        method: 'get'
    })
...
export function getMaterialPlatformData(pageNumber, pageSize, projectName, beginTime, endTime, materialType, materialName, spec) {
  return request({
    ...
    url: `/cscec5b-wzxt-web/openapi/checkDetail/queryDetailList?pageNumber=${1}&pageSize=${10}&projectName=${"润雅苑"}`,
    method: 'get'
  })
}